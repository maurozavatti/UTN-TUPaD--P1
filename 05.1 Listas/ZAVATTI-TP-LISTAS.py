...
clubes_futbol = ["Newells", "Boca", "River", "Independiente", "Racing"]

print(clubes_futbol[-2])
...
"""5) Analizar el siguiente programa y explicar con tus palabras qué es lo que realiza.
    ...
    print(numeros)
"""
#El programa lo que realiza es definir una lista de numeros enteros. Luego usa la funcion remove(max) para remover el valor maximo de dicha lista (en este caso el numero 22); y por ultimo imprime la nueva lista modificada sin el valor maximo.
...
## si se toma literalmente usando "append directamente" se puede hacer asi
dobles = []
dobles.append(5 * 2)
dobles.append(10 * 2)
dobles.append(15 * 2)
